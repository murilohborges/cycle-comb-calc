class Humidity:
  ...
  """
  def absolute_humidity_calc(self, saturation_pressure, local_atmospheric_pressure, relative_humidity):
    """
    Calculation of absolute humidity in kg of water/kg of dried air
    """
    steam_pressure = saturation_pressure*(relative_humidity/100)
