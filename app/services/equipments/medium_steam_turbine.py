class MediumSteamTurbine:
  ...
  def get_params_operation(self, input, saturation_parameters, entropy, enthalpy, secant_method):
    ...
    # Inlet params
    inlet_entropy = entropy.overheated_steam(input.medium_steam_level_pressure, input.medium_steam_level_temperature, saturation_parameters)
    inlet_enthalpy = enthalpy.overheated_steam(input.medium_steam_level_pressure, input.medium_steam_level_temperature, saturation_parameters)
    ...
    outlet_enthalpy_isentropic = enthalpy.overheated_steam(input.low_steam_level_pressure, outlet_temperature_isentropic, saturation_parameters)
