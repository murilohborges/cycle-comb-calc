class LowSteamTurbine:
  ...
  def get_params_operation(self, input, saturation_parameters, entropy, enthalpy, medium_steam_turbine, hrsg_data, secant_method):
    ...
    low_steam_enthalpy = enthalpy.overheated_steam(input.low_steam_level_pressure, input.low_steam_level_temperature, saturation_parameters)
    ...
    inlet_entropy = entropy.overheated_steam(input.low_steam_level_pressure, inlet_steam_temperature, saturation_parameters)
    ...
    liquid_saturated_outlet_entropy = entropy.saturated_liquid(outlet_pressure, saturation_parameters)
    steam_saturated_outlet_entropy = entropy.saturated_steam(outlet_pressure, saturation_parameters)
    ...
    liquid_saturated_outlet_enthalpy = enthalpy.saturated_liquid(outlet_pressure, saturation_parameters)
    steam_saturated_outlet_enthalpy = enthalpy.saturated_steam(outlet_pressure, saturation_parameters)
