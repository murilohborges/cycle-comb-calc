...
from app.services.equipments.medium_steam_turbine import MediumSteamTurbine

class TestMediumSteamTurbine:

  def test_get_params_operation_normal(self):
    """Test medium steam turbine calculation with valid data."""
    turbine = MediumSteamTurbine()

    # Input mocks
    input_mock = Mock()
    input_mock.medium_steam_level_pressure = 10
    input_mock.medium_steam_level_temperature = 500
    input_mock.medium_steam_level_efficiency = 85
    input_mock.low_steam_level_pressure = 5
  ...
  def test_get_params_operation_below_saturation_temperature(self):
    """Test medium steam turbine calculation with invalid data, incorrect input temperature."""
    turbine = MediumSteamTurbine()

    # Input mocks
    input_mock = Mock()
    input_mock.medium_steam_level_pressure = 10
    input_mock.medium_steam_level_temperature = 150  # below saturation
    input_mock.medium_steam_level_efficiency = 85
    input_mock.low_steam_level_pressure = 5
